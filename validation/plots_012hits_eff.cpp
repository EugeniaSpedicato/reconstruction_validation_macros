...
void plots_012hits_eff(string path){
...
f_thmu_LO_clone1.at(id) = TFile::Open(Form((path).c_str()+"mu_eff_LO_1hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_thmu_LO_clone2.at(id) = TFile::Open(Form((path).c_str()+"mu_eff_LO_2hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_thmu_LO_clone0.at(id) = TFile::Open(Form((path).c_str()+"mu_eff_LO_0hit_"+(range).c_str()+".root",static_cast<char>(id)));

f_the_LO_clone1.at(id) = TFile::Open(Form((path).c_str()+"el_eff_LO_1hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_the_LO_clone2.at(id) = TFile::Open(Form((path).c_str()+"el_eff_LO_2hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_the_LO_clone0.at(id) = TFile::Open(Form((path).c_str()+"el_eff_LO_0hit_"+(range).c_str()+".root",static_cast<char>(id)));

f_op_LO_clone1.at(id) = TFile::Open(Form((path).c_str()+"op_eff_LO_1hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_op_LO_clone2.at(id) = TFile::Open(Form((path).c_str()+"op_eff_LO_2hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_op_LO_clone0.at(id) = TFile::Open(Form((path).c_str()+"op_eff_LO_0hit_"+(range).c_str()+".root",static_cast<char>(id)));

f_thmu_single_LO_clone1.at(id) = TFile::Open(Form((path).c_str()+"mu_single_eff_LO_1hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_thmu_single_LO_clone2.at(id) = TFile::Open(Form((path).c_str()+"mu_single_eff_LO_2hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_thmu_single_LO_clone0.at(id) = TFile::Open(Form((path).c_str()+"mu_single_eff_LO_0hit_"+(range).c_str()+".root",static_cast<char>(id)));

f_the_single_LO_clone1.at(id) = TFile::Open(Form((path).c_str()+"el_single_eff_LO_1hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_the_single_LO_clone2.at(id) = TFile::Open(Form((path).c_str()+"el_single_eff_LO_2hit_"+(range).c_str()+".root",static_cast<char>(id)));
f_the_single_LO_clone0.at(id) = TFile::Open(Form((path).c_str()+"el_single_eff_LO_0hit_"+(range).c_str()+".root",static_cast<char>(id)));
}
