...
f_pre_1hit_el.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_prevrtx_clones_el_%d_1hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));

cout << "(m,id) " << m <<", " << id << "-> "<< 6*m+id << ": " << f_pre_1hit_el.at(6*m+id)->GetName() << endl;

f_post_1hit_el.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_vrtx_clones_el_%d_1hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
...
f_pre_0hit_el.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_prevrtx_clones_el_%d_0hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
f_post_0hit_el.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_vrtx_clones_el_%d_0hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
 }
}

for(int m=0; m<14; m++){
 for(int id=0; id<6; id++){
f_pre_1hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_prevrtx_clones_mu_%d_1hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
f_post_1hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_vrtx_clones_mu_%d_1hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
f_pre_2hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_prevrtx_clones_mu_%d_2hit_LO_index%d_newTuple_MS_v2.root",static_cast<char>(m),static_cast<char>(id)));
f_post_2hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_vrtx_clones_mu_%d_2hit_LO_index%d_newTuple_MS_v2.root",static_cast<char>(m),static_cast<char>(id)));
f_pre_0hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_prevrtx_clones_mu_%d_0hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
f_post_0hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_vrtx_clones_mu_%d_0hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
 }
}
...
cout << "(m,id) -> " << f_pre_1hit_el.at(0)->GetName() << endl;
cout << "(m,id) -> " << f_pre_1hit_el.at(1)->GetName() << endl;
cout << "(m,id) -> " << f_pre_1hit_el.at(2)->GetName() << endl;
cout << "(m,id) -> " << f_pre_1hit_el.at(3)->GetName() << endl;
cout << "(m,id) -> " << f_pre_1hit_el.at(4)->GetName() << endl;
cout << "(m,id) -> " << f_pre_1hit_el.at(5)->GetName() << endl;
...
n2_mu.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/results/prop_res_pre_mu_2hit_newTuple_MS_v2.pdf");
...
s2_pt2.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/results/sigma_linear_newTuple_MS_v2.pdf");
...
s1_pt2.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/results/sigma_log_newTuple_MS_v2.pdf");
