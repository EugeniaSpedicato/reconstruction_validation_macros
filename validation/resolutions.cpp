...
void resolutions(const char* reco_filename, const char* gen_filename, int nhits, const char* index){
...
h_res_el_pre.at(m)->SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/res_prevrtx_el_%d_%dhit_LO_index%s.root",static_cast<char>(m), static_cast<char>(nhits), index));
h_res_vrtx_el.at(m)->SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/res_vrtx_el_%d_%dhit_LO_index%s.root",static_cast<char>(m), static_cast<char>(nhits), index));
//gPad->SetLogy();
}
n0.SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/h_res_pre_el_%dhit_LO_index%s.pdf",static_cast<char>(nhits),index));
...
h_res_el_pre_clones.at(m)->SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/res_prevrtx_clones_el_%d_%dhit_LO_index%s.root",static_cast<char>(m), static_cast<char>(nhits), index));
h_res_vrtx_el_clones.at(m)->SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/res_vrtx_clones_el_%d_%dhit_LO_index%s.root",static_cast<char>(m), static_cast<char>(nhits), index));
}
n1.SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/h_res_vrtx_el_clones_%dhitLO_index%s.pdf",static_cast<char>(nhits),index));
...
h_res_mu_pre.at(m)->SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/res_prevrtx_mu_%d_%dhit_LO_index%s.root",static_cast<char>(m), static_cast<char>(nhits), index));
h_res_vrtx_mu.at(m)->SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/res_vrtx_mu_%d_%dhit_LO_index%s.root",static_cast<char>(m), static_cast<char>(nhits), index));
//gPad->SetLogy();
}
n2.SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/h_res_pre_mu_%dhit_LO_index%s.pdf",static_cast<char>(nhits),index));
...
h_res_mu_pre_clones.at(m)->SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/res_prevrtx_clones_mu_%d_%dhit_LO_index%s.root",static_cast<char>(m),static_cast<char>(nhits),index));
h_res_vrtx_mu_clones.at(m)->SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/res_vrtx_clones_mu_%d_%dhit_LO_index%s.root",static_cast<char>(m),static_cast<char>(nhits),index));
}
n3.SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/h_res_vrtx_mu_clones_%dhit_LO_index%s.pdf",static_cast<char>(nhits),index));

TCanvas in("in","in",700,700);
h_res_vrtx_muin->Draw();
in.SaveAs(Form("/home/espedica/macros_fairmu/validation/plots/h_res_pmuin_%dhit_LO_index%s.pdf",static_cast<char>(nhits),index));
