...
void efficiency_MC(const char* reco_filename, const char* gen_filename, int nhits, const char* index){
...
gStyle->SetOptStat(0);
a1.SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/plots/eff_LO_%dhit_%s.pdf",static_cast<char>(nhits),index));


h0_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/plots/el_single_eff_LO_%dhit_%s.root",static_cast<char>(nhits),index));
h1_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/plots/mu_single_eff_LO_%dhit_%s.root",static_cast<char>(nhits),index));
h2_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/plots/el_eff_LO_%dhit_%s.root",static_cast<char>(nhits),index));
h3_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/plots/mu_eff_LO_%dhit_%s.root",static_cast<char>(nhits),index));
h4_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/plots/op_eff_LO_%dhit_%s.root",static_cast<char>(nhits),index));
