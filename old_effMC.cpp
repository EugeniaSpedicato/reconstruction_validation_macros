...
//cbmsim->Add("/mnt/raid10/DATA/espedica/fairmu/theta_0-32mrad_1M_1hitFirstModules_NOoutchi2.root");

//cbmsim->Add("/mnt/raid10/DATA/espedica/fairmu/efficiency_NLO/theta_0-5mrad_1hitFirstModules_NOoutchi2_1M_notilt.root");


//cbmsim->Add("/mnt/raid10/DATA/espedica/fairmu/efficiency_NLO/theta_0-5mrad_1hit_NOoutchi2_1M_notilt.root");
...
if(find_if(quality_e.begin(),quality_e.end(),[](double i){return i>=0.65;})!=end(quality_e) and find_if(quality_mu.begin(),quality_mu.end(),[](double i){return i>=0.65;})!=end(quality_mu)){
 ...
 h_opening_clone->Fill(opening_angle,MesmerEvent->wgt_full*wnorm);
                 }else{h_2d->Fill(the_gen,thmu_gen,MesmerEvent->wgt_full*wnorm);}//if chi!=0
...
theta_e_gen->SaveAs("proposal/NOoutchi2_theta_e_gen_NLO_2hitFirstModules_02cut_quality.root");
theta_mu_gen->SaveAs("proposal/NOoutchi2_theta_mu_gen_NLO_2hitFirstModules_02cut_quality.root");
...
gStyle->SetOptStat(0);
a1.SaveAs("proposal/NOoutchi2_eff_NLO_reconstructibility_1hitFirstModules_02cut_quality.pdf");

h0->SaveAs("proposal/NOoutchi2_el_single_eff_NLO_2hitFirstModules_02cut_quality.root");
h1->SaveAs("proposal/NOoutchi2_mu_single_eff_NLO_2hitFirstModules_02cut_quality.root");
h2->SaveAs("proposal/NOoutchi2_el_eff_NLO_2hitFirstModules_02cut_quality.root");
h3->SaveAs("proposal/NOoutchi2_mu_eff_NLO_2hitFirstModules_02cut_quality.root");
h4->SaveAs("proposal/NOoutchi2_op_eff_NLO_2hitFirstModules_02cut_quality.root");

h0_clone->SaveAs("proposal/NOoutchi2_el_single_eff_NLO_2hitFirstModules_02cut_clone_quality.root");
h1_clone->SaveAs("proposal/NOoutchi2_mu_single_eff_NLO_2hitFirstModules_02cut_clone_quality.root");
h2_clone->SaveAs("proposal/NOoutchi2_el_eff_NLO_2hitFirstModules_02cut_clone_quality.root");
h3_clone->SaveAs("proposal/NOoutchi2_mu_eff_NLO_2hitFirstModules_02cut_clone_quality.root");
h4_clone->SaveAs("proposal/NOoutchi2_op_eff_NLO_2hitFirstModules_02cut_clone_quality.root");
...
h_2d->Draw("COLZ");
b2.SaveAs("proposal/NOoutchi2_notreco_NLO_2hitFirstModules_02cut_clone_quality.pdf");
*/
}
