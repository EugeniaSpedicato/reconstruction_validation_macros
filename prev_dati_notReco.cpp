...
d_eff->SaveAs("d_eff_RD_prev.root");

TCanvas b("b","b",700,700);
h_2d->Draw();
h_2d->SaveAs("2D_RD_prev.root");

TCanvas c("c","c",700,700);
theta_mu->Draw("E");
theta_mu->SaveAs("theta_mu_RD_prev.root");

TCanvas d("d","d",700,700);
theta_e->Draw("E");
theta_e->SaveAs("theta_e_RD_prev.root");
