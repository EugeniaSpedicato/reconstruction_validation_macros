...
void MC_LO_hit(){
TFile *f_thmu_LO1 = TFile::Open("proposal/NOoutchi2_mu_eff_LO_1hitFirstModules_quality.root");
TFile *f_thmu_LO2 = TFile::Open("proposal/NOoutchi2_mu_eff_LO_2hitFirstModules_quality.root");
TFile *f_thmu_LO0 = TFile::Open("proposal/NOoutchi2_mu_eff_LO_0hit_quality.root");

TFile *f_the_LO1 = TFile::Open("proposal/NOoutchi2_el_eff_LO_1hitFirstModules_quality.root");
TFile *f_the_LO2 = TFile::Open("proposal/NOoutchi2_el_eff_LO_2hitFirstModules_quality.root");
TFile *f_the_LO0 = TFile::Open("proposal/NOoutchi2_el_eff_LO_0hit_quality.root");

TFile *f_op_LO1 = TFile::Open("proposal/NOoutchi2_op_eff_LO_1hitFirstModules_quality.root");
TFile *f_op_LO2 = TFile::Open("proposal/NOoutchi2_op_eff_LO_2hitFirstModules_quality.root");
TFile *f_op_LO0 = TFile::Open("proposal/NOoutchi2_op_eff_LO_0hit_quality.root");

TFile *f_thmu_single_LO1 = TFile::Open("proposal/NOoutchi2_mu_single_eff_LO_1hitFirstModules_quality.root");
TFile *f_thmu_single_LO2 = TFile::Open("proposal/NOoutchi2_mu_single_eff_LO_2hitFirstModules_quality.root");
TFile *f_thmu_single_LO0 = TFile::Open("proposal/NOoutchi2_mu_single_eff_LO_0hit_quality.root");

TFile *f_the_single_LO1 = TFile::Open("proposal/NOoutchi2_el_single_eff_LO_1hitFirstModules_quality.root");
TFile *f_the_single_LO2 = TFile::Open("proposal/NOoutchi2_el_single_eff_LO_2hitFirstModules_quality.root");
TFile *f_the_single_LO0 = TFile::Open("proposal/NOoutchi2_el_single_eff_LO_0hit_quality.root");



TFile *f_thmu_LO_clone1 = TFile::Open("proposal/NOoutchi2_mu_eff_LO_1hitFirstModules_clone_quality.root");
TFile *f_thmu_LO_clone2 = TFile::Open("proposal/NOoutchi2_mu_eff_LO_2hitFirstModules_clone_quality.root");
TFile *f_thmu_LO_clone0 = TFile::Open("proposal/NOoutchi2_mu_eff_LO_0hit_clone_quality.root");

TFile *f_the_LO_clone1 = TFile::Open("proposal/NOoutchi2_el_eff_LO_1hitFirstModules_clone_quality.root");
TFile *f_the_LO_clone2 = TFile::Open("proposal/NOoutchi2_el_eff_LO_2hitFirstModules_clone_quality.root");
TFile *f_the_LO_clone0 = TFile::Open("proposal/NOoutchi2_el_eff_LO_0hit_clone_quality.root");

TFile *f_op_LO_clone1 = TFile::Open("proposal/NOoutchi2_op_eff_LO_1hitFirstModules_clone_quality.root");
TFile *f_op_LO_clone2 = TFile::Open("proposal/NOoutchi2_op_eff_LO_2hitFirstModules_clone_quality.root");
TFile *f_op_LO_clone0 = TFile::Open("proposal/NOoutchi2_op_eff_LO_0hit_clone_quality.root");

TFile *f_thmu_single_LO_clone1 = TFile::Open("proposal/NOoutchi2_mu_single_eff_LO_1hitFirstModules_clone_quality.root");
TFile *f_thmu_single_LO_clone2 = TFile::Open("proposal/NOoutchi2_mu_single_eff_LO_2hitFirstModules_clone_quality.root");
TFile *f_thmu_single_LO_clone0 = TFile::Open("proposal/NOoutchi2_mu_single_eff_LO_0hit_clone_quality.root");

TFile *f_the_single_LO_clone1 = TFile::Open("proposal/NOoutchi2_el_single_eff_LO_1hitFirstModules_clone_quality.root");
TFile *f_the_single_LO_clone2 = TFile::Open("proposal/NOoutchi2_el_single_eff_LO_2hitFirstModules_clone_quality.root");
TFile *f_the_single_LO_clone0 = TFile::Open("proposal/NOoutchi2_el_single_eff_LO_0hit_clone_quality.root");
...
TH1D *h_theta_e_single_LO_clone2=(TH1D*)f_the_single_LO_clone2->Get("theta_e_single_clone");
 ...
 auto legend_e_single = new TLegend();
   legend_e_single->AddEntry(h_theta_e_single_LO_clone0,"LO 0 hit","LEP");
   legend_e_single->AddEntry(h_theta_e_single_LO_clone1,"LO 1 hit","LEP");
   legend_e_single->AddEntry(h_theta_e_single_LO_clone2,"LO 2 hit","LEP");

 auto legend_mu_single = new TLegend();
   legend_mu_single->AddEntry(h_theta_mu_single_LO_clone0,"LO 0 hit","LEP");
   legend_mu_single->AddEntry(h_theta_mu_single_LO_clone1,"LO 1 hit","LEP");
   legend_mu_single->AddEntry(h_theta_mu_single_LO_clone2,"LO 2 hit","LEP");
...
a.SaveAs("proposal/eff_single_LO_012hitFirstModules_clone_quality.pdf");
...
legend_op->Draw();
gStyle->SetOptStat(0);
a1.SaveAs("proposal/eff_event_LO_012hitFirstModules_clone_quality.pdf");
