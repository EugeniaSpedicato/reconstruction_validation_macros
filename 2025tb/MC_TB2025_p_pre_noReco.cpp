...
cbmsim->Add("/mnt/raid10/DATA/espedica/fairmu/TB2025/MC/1M_tar0_1.root");
cbmsim->Add("/mnt/raid10/DATA/espedica/fairmu/TB2025/MC/500k_tar0_2.root");
cbmsim->Add("/mnt/raid10/DATA/espedica/fairmu/TB2025/MC/500k_tar0_3.root");
}
...
if(chi>0 and stub1<=15 and thmu_rec>0.0002 and the_rec<0.020 and the_rec>=0.005 and thmu_rec<=Elastic2+0.0002 and thmu_rec>=Elastic2-0.0002 and abs(acoplanarity_v)<=0.4 and zpos>650){
