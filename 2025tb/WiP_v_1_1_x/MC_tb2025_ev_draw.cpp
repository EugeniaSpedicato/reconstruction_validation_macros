...
z=vrtx.at(0).zKinematicFit();
 ...
 MUonERecoOutputTrackFull mu_in = vrtx.at(0).incomingMuon();
 MUonERecoOutputTrackFull mu_out = vrtx.at(0).outgoingMuon();
 MUonERecoOutputTrackFull e_out = vrtx.at(0).outgoingElectron();

double chi=vrtx.at(0).chi2perDegreeOfFreedom();
cout << "vrtx chi2 " << vrtx.at(0).chi2perDegreeOfFreedom() << endl;
...
cout << "vrtx.at(0).stationIndex() " << vrtx.at(0).stationIndex() << endl;
