...
int rndm_preVrtx_report_count_snakemake(int run, string type, string filen, int nhits){
...
ROOT::TTreeProcessorMT tp1(*cbmsim,nthreads);
   ...
   ROOT::TThreadedObject<TH1D> h_opening_1("h_opening_1","opening angle tar 1",160,0.,0.032);
...
//if(chi!=0 and vrtx.at(0).stationIndex()==1 and *trig_smi0==1){ h_nvrtx_1->Fill(1);}
//else if(chi!=0 and vrtx.at(0).stationIndex()==2 and *trig_smi1==1){ h_nvrtx_2->Fill(1);}
...
if(entry%2==0){track_1=track_vrtx1.at(0);track_2=track_vrtx1.at(1);}
	...
	double zpos =0;
		...
		if(IP_out<0.2){
		 ...
		 h_Dz_vrtx_0->Fill(667.3-2.7-(667.3-2.7));
		 ...
		 if(stub1<=15 and abs(acoplanarity_v)<=0.3 and abs(667.3-2.7-(667.3-2.7))<3. and th1<0.02 and th2>0.0002 and th2<0.02 and th1>0.0002){
		  ...
		  h_preE_th_min_0->Fill(th2);
		  h_preE_th_max_0->Fill(th1);
		  h_elastic_0->Fill(th2);
		  h_el_1->Fill(th1,th2);

			        elastic_1->Fill(1);
	        	        h_E_th_min_0->Fill(th2);
		                h_E_th_max_0->Fill(th1);
                                ...
                                h_final_Dz_vrtx_0->Fill(667.3-2.7-(667.3-2.7));
				h_final_aco_0->Fill(acoplanarity_v);
                                h_final_chi2_tr0_0->Fill(track_0.at(0).chi2());
                                h_final_chi2_trMax_0->Fill(track_1.chi2());
				h_final_chi2_trMin_0->Fill(track_2.chi2());
                                h_opening_0->Fill(p_mu.Angle(p_e));
				//h_el_1->Fill(th1,th2);
	...
	fiducial_2->Fill(1.);
        ...
        h_thx_1->Fill(track_vrtx1.at(0).xSlope());
        h_thy_1->Fill(track_vrtx1.at(0).ySlope());
...
if(entry%2==0){track_1=track_vrtx2.at(0);track_2=track_vrtx2.at(1);}
	...
	h_nvrtx_2->Fill(1);
		 ...
		 h_Dz_vrtx_1->Fill(784.6-3.9-(784.6-3.9));
		 ...
		 if(stub2<=15 and abs(acoplanarity_v)<=0.3 and abs(784.6-3.9-(784.6-3.9))<3. and th1<0.02 and th2>0.0002 and th2<0.02 and th1>0.0002){
		  ...
		  h_preEl_th_min_1->Fill(th2);
		  h_preE_th_max_1->Fill(th1);
		  h_elastic_1->Fill(th2);
				h_el_2->Fill(th1,th2);

                                elastic_2->Fill(1);
                                h_E_th_min_1->Fill(th2);
                                h_E_th_max_1->Fill(th1);
                                ...
                                h_final_Dz_vrtx_1->Fill(784.6-3.9-(784.6-3.9));
                                h_final_aco_1->Fill(acoplanarity_v);
                                h_final_chi2_tr0_1->Fill(track_vrtx1.at(0).chi2());
                                h_final_chi2_trMax_1->Fill(track_1.chi2());
                                h_final_chi2_trMin_1->Fill(track_2.chi2());
				//h_el_2->Fill(th1,th2);
                                h_opening_1->Fill(p_mu.Angle(p_e));
                        }
		}
	}
}
...
//cout << "fiducial_1->Integral() " << fiducial_1->Integral() << endl;
    ...
    std::ofstream out(Form("txt/run%i/rndm_preVrtx_report_%s_%s_nhits%i.txt",run,type.c_str(),filen.c_str(),nhits)); // apre (o crea) il file in scrittura
    if (!out) {
    ...
    TFile out_root(Form("txt/run%i/rndm_preVrtx_root_%s_%s_nhits%i.root",run,type.c_str(),filen.c_str(),nhits),"recreate");
