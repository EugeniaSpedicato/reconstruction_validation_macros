...
pos.SaveAs(Form("plots/run%i/rndm_preVrtx_preFid_postion_nhits%i.pdf",run,hits));
...
gen.SaveAs(Form("plots/run%i/rndm_preVrtx_postFid_nhits%i.pdf",run,hits));
...
pe.SaveAs(Form("plots/run%i/rndm_preVrtx_preEl_nhits%i.pdf",run,hits));
h_E_th_min_0.at(0)->SaveAs(Form("plots/run%i/thetas/rndm_preVrtx_thetaMin0.root",run));
h_E_th_min_1.at(0)->SaveAs(Form("plots/run%i/thetas/rndm_preVrtx_thetaMin1.root",run));
h_E_th_max_0.at(0)->SaveAs(Form("plots/run%i/thetas/rndm_preVrtx_thetaMax0.root",run));
h_E_th_max_1.at(0)->SaveAs(Form("plots/run%i/thetas/rndm_preVrtx_thetaMax1.root",run));

h_opening_0.at(0)->Rebin(4);
h_opening_1.at(0)->Rebin(4);
h_opening_0.at(0)->SaveAs(Form("plots/run%i/thetas/rndm_preVrtx_opening0.root",run));
h_opening_1.at(0)->SaveAs(Form("plots/run%i/thetas/rndm_preVrtx_opening1.root",run));
...
fe.SaveAs(Form("plots/run%i/rndm_preVrtx_finalEl_nhits%i.pdf",run,hits));
...
gen_fin.SaveAs(Form("plots/run%i/rndm_preVrtx_final_nhits%i.pdf",run,hits));
gen_fin.SaveAs(Form("plots/run%i/rndm_preVrtx_final_nhits%i.root",run,hits));
