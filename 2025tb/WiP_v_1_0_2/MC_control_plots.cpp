...
//TFile* f_0 = TFile::Open(Form("txt/run%s/root_single_int_0_%s.root",run,file.c_str()));
//TFile* f_1 = TFile::Open(Form("txt/run%s/root_single_int_1_%s.root",run,file.c_str()));
...
pos.SaveAs(Form("plots/run%s/wip11x_preFid_postion.pdf",run));
...
gen.SaveAs(Form("plots/run%s/wip11x_postFid.pdf",run));
...
pe.SaveAs(Form("plots/run%s/wip11x_preEl.pdf",run));
pe.SaveAs(Form("plots/run%s/wip11x_preEl.root",run));
...
fe.SaveAs(Form("plots/run%s/wip11x_finalEl.pdf",run));
h_E_th_min_0.at(0)->SaveAs(Form("plots/run%s/thetas/wip11x_thetaMin0.root",run));
h_E_th_min_1.at(0)->SaveAs(Form("plots/run%s/thetas/wip11x_thetaMin1.root",run));
h_E_th_max_0.at(0)->SaveAs(Form("plots/run%s/thetas/wip11x_thetaMax0.root",run));
h_E_th_max_1.at(0)->SaveAs(Form("plots/run%s/thetas/wip11x_thetaMax1.root",run));
...
gen_fin.SaveAs(Form("plots/run%s/wip11x_final.pdf",run));
gen_fin.SaveAs(Form("plots/run%s/wip11x_final.root",run));
