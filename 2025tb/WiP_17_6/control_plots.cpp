...
pos.SaveAs(Form("plots/run%i/oldVersion_preFid_postion_nhits%i.pdf",run,hits));
...
gen.SaveAs(Form("plots/run%i/oldVersion_postFid_nhits%i.pdf",run,hits));
...
pe.SaveAs(Form("plots/run%i/oldVersion_preEl_nhits%i.pdf",run,hits));
pe.SaveAs(Form("plots/run%i/oldVersion_preEl_nhits%i.root",run,hits));
...
fe.SaveAs(Form("plots/run%i/oldVersion_finalEl_nhits%i.pdf",run,hits));
...
gen_fin.SaveAs(Form("plots/run%i/oldVersion_final_nhits%i.pdf",run,hits));
gen_fin.SaveAs(Form("plots/run%i/oldVersion_final_nhits%i.root",run,hits));
