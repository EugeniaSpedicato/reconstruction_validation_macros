...
pos.SaveAs(Form("plots/run%s/preVrtx_preFid_postion.pdf",run));
...
gen.SaveAs(Form("plots/run%s/preVrtx_postFid.pdf",run));
...
pe.SaveAs(Form("plots/run%s/preVrtx_preEl.pdf",run));
pe.SaveAs(Form("plots/run%s/preVrtx_preEl.root",run));
...
fe.SaveAs(Form("plots/run%s/preVrtx_finalEl.pdf",run));
h_E_th_min_0.at(0)->SaveAs(Form("plots/run%s/thetas/preVrtx_thetaMin0.root",run));
h_E_th_min_1.at(0)->SaveAs(Form("plots/run%s/thetas/preVrtx_thetaMin1.root",run));
h_E_th_max_0.at(0)->SaveAs(Form("plots/run%s/thetas/preVrtx_thetaMax0.root",run));
h_E_th_max_1.at(0)->SaveAs(Form("plots/run%s/thetas/preVrtx_thetaMax1.root",run));
...
gen_fin.SaveAs(Form("plots/run%s/preVrtx_final.pdf",run));
gen_fin.SaveAs(Form("plots/run%s/preVrtx_final.root",run));
