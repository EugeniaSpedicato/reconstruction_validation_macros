...
double other_z2=0;
	...
	const char *name;
        ...
        if(nhits==0 and version==2025 and interaction==0){name="/home/marconi/effRecoECAL/selected_T1_ECAL_30_muedaq01-1754189393.root";}
...
cout<<"vrtx IP " << vrtx.distanceBetweenOutgoingTracksAtTargetZ() << endl;

x=vrtx.xKinematicFit();
y=vrtx.yKinematicFit();
z=vrtx.zKinematicFit();

 MUonERecoOutputTrackAnalysis mu_in = vrtx.incomingMuon();
