...
//TFile* f_0 = TFile::Open(Form("txt/run%s/root_single_muon_interaction_0_%s_nhits%i.root",run,file.c_str()));
//TFile* f_1 = TFile::Open(Form("txt/run%s/root_single_muon_interaction_1_%s_nhits%i.root",run,file.c_str()));
...
char* run = argv[2];
    ...
    for (auto& entry : fs::directory_iterator(folder)) {
        if (fs::is_regular_file(entry.path()) && entry.path().extension() == ".root" and entry.path().string().find("rndm_preVrtx") != std::string::npos) {
...
std::vector<TH1D*> h_opening_0(files_0.size(), nullptr);
...
std::vector<TH1D*> h_opening_1(files_1.size(), nullptr);
...
h_opening_0.at(f)=(TH1D*)f_0->Get("h_opening_0");
...
h_opening_0.at(0)->Add(h_opening_0.at(f));
...
h_opening_1.at(f)=(TH1D*)f_0->Get("h_opening_1");
...
h_opening_1.at(0)->Add(h_opening_1.at(f));
...
h_opening_0.at(0)->Scale(1./h_opening_0.at(0)->Integral());
...
h_opening_1.at(0)->Scale(1./h_opening_1.at(0)->Integral());
...
pos.SaveAs(Form("plots/run%s/rndm_preVrtx_preFid_postion_nhits%i.pdf",run));
...
gen.SaveAs(Form("plots/run%s/rndm_preVrtx_postFid_nhits%i.pdf",run));

TCanvas pe("pe","pe",1500,1500);
pe.Divide(3,3);
pe.cd(1);
h_preE_th_min_0.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_preE_th_min_1.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_preE_th_min_0.at(0)->Draw("hist");
h_preE_th_min_1.at(0)->SetLineColor(kRed);
h_preE_th_min_1.at(0)->Draw("hist sames");
pe.cd(2);
h_preE_th_max_0.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_preE_th_max_1.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
...
h1->GetXaxis()->SetRangeUser(0.,0.02);
h1->SetMinimum(0.6);
h1->SetMaximum(1.4);
...
h2->GetXaxis()->SetRangeUser(0.,0.02);
h2->SetMinimum(0.6);
h2->SetMaximum(1.4);
...
pe.cd(7);
h_el_1.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_el_1.at(0)->GetYaxis()->SetRangeUser(0.,0.02);
h_el_1.at(0)->Draw("COLZ");
pe.cd(8);
h_el_2.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_el_2.at(0)->GetYaxis()->SetRangeUser(0.,0.02);
h_el_2.at(0)->Draw("COLZ");

pe.SaveAs(Form("plots/run%s/rndm_preVrtx_preEl_nhits%i.pdf",run));
h_E_th_min_0.at(0)->SaveAs(Form("plots/run%s/thetas/rndm_preVrtx_thetaMin0.root",run));
h_E_th_min_1.at(0)->SaveAs(Form("plots/run%s/thetas/rndm_preVrtx_thetaMin1.root",run));
h_E_th_max_0.at(0)->SaveAs(Form("plots/run%s/thetas/rndm_preVrtx_thetaMax0.root",run));
h_E_th_max_1.at(0)->SaveAs(Form("plots/run%s/thetas/rndm_preVrtx_thetaMax1.root",run));
h_opening_0.at(0)->Rebin(4);
h_opening_1.at(0)->Rebin(4);
h_opening_0.at(0)->SaveAs(Form("plots/run%s/thetas/rndm_preVrtx_opening0.root",run));
h_opening_1.at(0)->SaveAs(Form("plots/run%s/thetas/rndm_preVrtx_opening1.root",run));


TCanvas fe("fe","fe",1000,1000);
fe.Divide(3,2);
fe.cd(1);
h_E_th_min_0.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_E_th_min_1.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_E_th_min_0.at(0)->Draw("hist");
h_E_th_min_1.at(0)->SetLineColor(kRed);
h_E_th_min_1.at(0)->Draw("hist sames");
fe.cd(2);
h_E_th_max_0.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_E_th_max_1.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
...
fe.cd(3);
h_opening_0.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_opening_1.at(0)->GetXaxis()->SetRangeUser(0.,0.02);
h_opening_0.at(0)->Draw("hist");
h_opening_1.at(0)->SetLineColor(kRed);
h_opening_1.at(0)->Draw("hist sames");

fe.cd(4);
TH1D * h1_el = (TH1D*) h_E_th_min_0.at(0)->Clone();
h1_el->Divide(h_E_th_min_1.at(0));
h1_el->GetXaxis()->SetRangeUser(0.,0.02);
...
h2_el->GetXaxis()->SetRangeUser(0.,0.02);
...
fe.cd(6);
TH1D * hop_el = (TH1D*) h_opening_0.at(0)->Clone();
hop_el->Divide(h_opening_1.at(0));
hop_el->GetXaxis()->SetRangeUser(0.,0.02);
hop_el->SetMinimum(0.2);
hop_el->SetMaximum(2);
hop_el->SetTitle("#theta_op Tar_0/Tar_1");
hop_el->Draw();

fe.SaveAs(Form("plots/run%s/rndm_preVrtx_finalEl_nhits%i.pdf",run));
...
gen_fin.SaveAs(Form("plots/run%s/rndm_preVrtx_final_nhits%i.pdf",run));
gen_fin.SaveAs(Form("plots/run%s/rndm_preVrtx_final_nhits%i.root",run));
