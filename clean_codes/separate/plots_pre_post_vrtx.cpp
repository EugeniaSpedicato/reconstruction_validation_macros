...
//f_pre_1hit_el.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/res_prevrtx_clones_el_%d_1hit_LO_index%d_258faf6b.root",static_cast<char>(m),static_cast<char>(id)));
//f_post_1hit_el.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/res_vrtx_clones_el_%d_1hit_LO_index%d_258faf6b.root",static_cast<char>(m),static_cast<char>(id)));
f_pre_2hit_el.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/res_prevrtx_clones_el_%d_2hit_LO_index%d_allNewFeatures.root",static_cast<char>(m),static_cast<char>(id)));
f_post_2hit_el.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/res_vrtx_clones_el_%d_2hit_LO_index%d_allNewFeatures.root",static_cast<char>(m),static_cast<char>(id)));
 }
}

for(int m=0; m<14; m++){
 for(int id=0; id<6; id++){
//f_pre_1hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/res_prevrtx_clones_AngleMu_%d_1hit_LO_index%d_258faf6b_allNewFeatures.root",static_cast<char>(m),static_cast<char>(id)));
//f_post_1hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/res_vrtx_clones_AngleMu_%d_1hit_LO_index%d_258faf6b_allNewFeatures.root",static_cast<char>(m),static_cast<char>(id)));
f_pre_2hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/res_prevrtx_clones_AngleMu_%d_2hit_LO_index%d_allNewFeatures.root",static_cast<char>(m),static_cast<char>(id)));
f_post_2hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/res_vrtx_clones_AngleMu_%d_2hit_LO_index%d_allNewFeatures.root",static_cast<char>(m),static_cast<char>(id)));
 }
}
...
n.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_el_pre_1hit_allNewFeatures.pdf");
...
n1.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_el_post_1hit_allNewFeatures.pdf");
*/
...
n2.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_el_pre_2hit_allNewFeatures.pdf");
...
//n3.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_el_pre_2hit_allNewFeatures.pdf");
...
n4.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_el_post_2hit_allNewFeatures.pdf");
...
n5.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_mu_pre_1hit_allNewFeatures.pdf");
...
n6.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_mu_post_1hit_allNewFeatures.pdf");
*/
...
n7.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_mu_pre_2hit_allNewFeatures.pdf");
...
//n2_mu.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_pre_AngleMu_2hit_allNewFeatures.pdf");
...
n8.SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/res_mu_post_2hit_allNewFeatures.pdf");
...
h_sigma_el_pre_2hit_clones->SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/sigma_el_pre_2hit_allNewFeatures.root");
h_sigma_el_post_2hit_clones->SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/sigma_el_post_2hit_allNewFeatures.root");
h_sigma_mu_pre_2hit_clones->SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/sigma_mu_pre_2hit_allNewFeatures.root");
h_sigma_mu_post_2hit_clones->SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/sigma_mu_post_2hit_allNewFeatures.root");
...
//sigma_el_diff_1hit->SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/el_1.root"); 
//sigma_mu_diff_1hit->SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/mu_1.root"); 
sigma_el_diff_2hit->SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/el_2_allNewFeatures.root"); 
sigma_mu_diff_2hit->SaveAs("/home/espedica/macros_fairmu/clean_codes/separate/validation/results/mu_2_allNewFeatures.root");
