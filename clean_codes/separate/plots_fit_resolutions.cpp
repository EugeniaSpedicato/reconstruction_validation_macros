...
for(int m=0; m<14; m++){
 for(int id=0; id<6; id++){
f_pre_1hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_prevrtx_clones_AngleMu_%d_1hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
f_post_1hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_vrtx_clones_AngleMu_%d_1hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
...
f_pre_0hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_prevrtx_clones_AngleMu_%d_0hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
f_post_0hit_mu.at(6*m+id)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/separate/validation/old_WiP/res_vrtx_clones_AngleMu_%d_0hit_LO_index%d.root",static_cast<char>(m),static_cast<char>(id)));
 }
}
