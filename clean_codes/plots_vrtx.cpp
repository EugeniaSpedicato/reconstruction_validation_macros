...
TFile *f_thmu_LO_clone1 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_mu_gen_1hit.root");
TFile *f_thmu_LO_clone2 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_mu_gen_2hit.root");
TFile *f_thmu_LO_clone0 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_mu_gen_0hit.root");

TFile *f_the_LO_clone1 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_el_gen_1hit.root");
TFile *f_the_LO_clone2 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_el_gen_2hit.root");
TFile *f_the_LO_clone0 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_el_gen_0hit.root");

TFile *f_op_LO_clone1 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_op_gen_1hit.root");
TFile *f_op_LO_clone2 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_op_gen_2hit.root");
TFile *f_op_LO_clone0 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/quality_op_gen_0hit.root");

TFile *f_op_NLO_quality1 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/vrtx_wrong_LO_1hit_true_clone_quality.root");
TFile *f_op_NLO_quality2 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/vrtx_wrong_LO_2hit_true_clone_quality.root");
TFile *f_op_NLO_quality0 = TFile::Open("/home/espedica/macros_fairmu/clean_codes/validation/vrtx_wrong_LO_0hit_true_clone_quality.root");
...
TH1D *h_op_NLO_quality0=(TH1D*)f_op_NLO_quality0->Get("h_opening_wrong_vrtx");
TH1D *h_op_NLO_quality1=(TH1D*)f_op_NLO_quality1->Get("h_opening_wrong_vrtx");
TH1D *h_op_NLO_quality2=(TH1D*)f_op_NLO_quality2->Get("h_opening_wrong_vrtx");
...
h_op_NLO_quality2->GetXaxis()->SetTitle("Opening angle [rad] ");
h_op_NLO_quality2->GetYaxis()->SetTitle("Probability (wrong vertexing) ");
h_op_NLO_quality2->SetMaximum(1);
//h_op_NLO_quality2->SetMinimum(0.0000001);
...
q.SaveAs("/home/espedica/macros_fairmu/clean_codes/validation/results/wrong_vrtxing_LO.pdf");
...
TCanvas a1("a1","a1",2300,700);
a1.Divide(3,1);
a1.cd(1);
h_theta_mu_LO_clone2->SetTitle("");
...
legend_op->Draw();
gStyle->SetOptStat(0);
a1.SaveAs("/home/espedica/macros_fairmu/clean_codes/validation/results/vrtx_eff_event_LO_012hit.pdf");
