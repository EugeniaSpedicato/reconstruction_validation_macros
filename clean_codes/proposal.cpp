...
array<TFile*,14> f_pre_1hit_el, f_post_1hit_el, f_pre_2hit_el, f_post_2hit_el, f_pre_0hit_el, f_post_0hit_el;
array<TFile*,14> f_pre_1hit_mu, f_post_1hit_mu, f_pre_2hit_mu, f_post_2hit_mu, f_pre_0hit_mu, f_post_0hit_mu;;
...
f_pre_2hit_el.at(m)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/validation/res_prevrtx_clones_el_%d_2hit_LO.root",static_cast<char>(m)));
f_post_2hit_el.at(m)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/validation/res_vrtx_clones_el_%d_2hit_LO.root",static_cast<char>(m)));
f_pre_0hit_el.at(m)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/validation/res_prevrtx_clones_el_%d_0hit_LO.root",static_cast<char>(m)));
f_post_0hit_el.at(m)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/validation/res_vrtx_clones_el_%d_0hit_LO.root",static_cast<char>(m)));
}
...
f_pre_2hit_mu.at(m)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/validation/res_prevrtx_clones_AngleMu_%d_2hit_LO.root",static_cast<char>(m)));
f_post_2hit_mu.at(m)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/validation/res_vrtx_clones_AngleMu_%d_2hit_LO.root",static_cast<char>(m)));
f_pre_0hit_mu.at(m)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/validation/res_prevrtx_clones_AngleMu_%d_0hit_LO.root",static_cast<char>(m)));
f_post_0hit_mu.at(m)=TFile::Open(Form("/home/espedica/macros_fairmu/clean_codes/validation/res_vrtx_clones_AngleMu_%d_0hit_LO.root",static_cast<char>(m)));
}
...
n2.SaveAs("/home/espedica/macros_fairmu/clean_codes/validation/results/prop_res_pre_el_2hit.pdf");
...
n2_mu.SaveAs("/home/espedica/macros_fairmu/clean_codes/validation/results/prop_res_pre_AngleMu_2hit.pdf");
...
h_sigma_mu_pre_1hit_clones->SetMarkerStyle(20);
h_sigma_mu_pre_2hit_clones->SetMarkerStyle(20);
h_sigma_mu_pre_0hit_clones->SetMarkerStyle(20);

mu_1hit_pt2->Add(h_sigma_mu_pre_0hit_clones,"A*");
mu_1hit_pt2->Add(h_sigma_mu_pre_1hit_clones,"A*");
mu_1hit_pt2->Add(h_sigma_mu_pre_2hit_clones,"A*");
...
h_sigma_el_pre_1hit_clones->SetMarkerStyle(20);
h_sigma_el_pre_2hit_clones->SetMarkerStyle(20);
h_sigma_el_pre_0hit_clones->SetMarkerStyle(20);

el_1hit_pt2->Add(h_sigma_el_pre_0hit_clones,"A*");
el_1hit_pt2->Add(h_sigma_el_pre_1hit_clones,"A*");
el_1hit_pt2->Add(h_sigma_el_pre_2hit_clones,"A*");
...
s2_pt2.SaveAs("/home/espedica/macros_fairmu/clean_codes/validation/results/sigma_linear.pdf");
...
s1_pt2.SaveAs("/home/espedica/macros_fairmu/clean_codes/validation/results/sigma_log.pdf");
...
mu_1hit->Add(h_sigma_mu_pre_1hit_clones,"A*");
mu_1hit->Add(h_sigma_mu_post_1hit_clones,"A*");
...
mu_2hit->Add(h_sigma_mu_pre_2hit_clones,"A*");
mu_2hit->Add(h_sigma_mu_post_2hit_clones,"A*");
...
el_1hit->Add(h_sigma_el_pre_1hit_clones,"A*");
el_1hit->Add(h_sigma_el_post_1hit_clones,"A*");
...
el_2hit->Add(h_sigma_el_pre_2hit_clones,"A*");
el_2hit->Add(h_sigma_el_post_2hit_clones,"A*");
...
s2.SaveAs("/home/espedica/macros_fairmu/clean_codes/validation/results/sigma_linear_prepost.pdf");
...
s1.SaveAs("/home/espedica/macros_fairmu/clean_codes/validation/results/sigma_log_prepost.pdf");
