...
gStyle->SetOptStat(0);
a1.SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/eff_LO_%dhit.pdf",static_cast<char>(nhits)));


h0_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/el_single_eff_LO_%dhit.root",static_cast<char>(nhits)));
h1_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/mu_single_eff_LO_%dhit.root",static_cast<char>(nhits)));
h2_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/el_eff_LO_%dhit.root",static_cast<char>(nhits)));
h3_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/mu_eff_LO_%dhit.root",static_cast<char>(nhits)));
h4_clone->SaveAs(Form("/home/espedica/macros_fairmu/clean_codes/validation/op_eff_LO_%dhit.root",static_cast<char>(nhits)));
