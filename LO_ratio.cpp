...
void LO_ratio(int nhits_rd,int nhits_mc, string rd, string mc){
...
TH1D *h_track_mu_RD=(TH1D*)f_track_mu_RD->Get("track_mu");
   ...
   double sum_Nw = 0;
   sum_Nw = accumulate(a_sum_Nw, a_sum_Nw+7, sum_Nw);


   double sum_w_wnorm = wnorm*9.99791e+06;

   double sum_w2_wnorm = wnorm*wnorm*1.50706e+07;
  ...
  cout << "cs " << sum_w_wnorm/sum_Nw << endl;
    ...
    entries = 6.78847e+06;
    cross_section = wnorm * 9.99791e+06/sum_Nw;

  cout << "cs " << sum_w_wnorm/sum_Nw << endl;

if(rd=="my_modifica_golden_all") n_mu_ot=8.98816e+08;
if(rd=="my_modifica_eos") n_mu_ot=8.8016548e+08*0.86;//n_mu_ot=7.9729075e+08;

    d_tar=3.;
    w2_fiducial=1.02324e+07;
    w2_elastic=635287;
