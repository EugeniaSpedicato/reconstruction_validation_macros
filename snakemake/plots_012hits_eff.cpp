...
a.SaveAs(Form("/home/espedica/macros_fairmu/snakemake/plots/results/eff_single_LO_012hit_%s.pdf",info.c_str()));
...
legend_op->Draw();
gStyle->SetOptStat(0);
a1.SaveAs(Form("/home/espedica/macros_fairmu/snakemake/plots/results/eff_event_LO_012hit_%s.pdf",info.c_str()));
