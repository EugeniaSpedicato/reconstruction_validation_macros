...
cbmsim->Add("/mnt/raid10/DATA/espedica/fairmu/minbias_1M_new_085PUmean.root");
  ...
  TH1D *h_nTotStubs_after_ALLPUmu_eff97 = new TH1D("h_nTotStubs_after","Total N of Stubs after skim with ALLPUmu_eff97",nb,0,nmax);
...
h_nTotStubs_after_ALLPUmu_eff97->Fill(TrackerStubs->GetEntries());
...
h_nTotStubs_after_ALLPUmu_eff97->SetLineColor(kRed);
h_nTotStubs_after_ALLPUmu_eff97->SetLineWidth(3);
h_nTotStubs_after_ALLPUmu_eff97->Draw("hist same");
gPad->SetLogy();
gStyle->SetOptStat(0);
a.SaveAs("nstubs_ALLPUmu_eff97.pdf");
