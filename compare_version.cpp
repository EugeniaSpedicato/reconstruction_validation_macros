...
void compare_version(string path1, string path2, string info1, string info2){
...
d.SaveAs(Form("%sdiff_%s.pdf",path2.c_str(),info2.c_str()));
...
d2.SaveAs(Form("%ssigma_overlap_%s.pdf",path2.c_str(),info2.c_str()));
...
h_op_LO_clone0_testing->Draw(" same");
 auto l0 = new TLegend(0.65,0.15,0.9,0.3);
...
h_op_LO_clone1_testing->Draw(" same");
 auto l1 = new TLegend(0.65,0.15,0.9,0.3);
...
h_op_LO_clone2_testing->Draw(" same");
 auto l2 = new TLegend(0.65,0.15,0.9,0.3);
...
h_theta_mu_single_LO_clone0_testing->Draw(" same");
 auto l0_a = new TLegend(0.65,0.15,0.9,0.3);
...
h_theta_mu_single_LO_clone1_testing->Draw(" same");
 auto l1_a = new TLegend(0.65,0.15,0.9,0.3);
...
h_theta_mu_single_LO_clone2_testing->Draw(" same");
 auto l2_a = new TLegend(0.65,0.15,0.9,0.3);
...
h_theta_e_single_LO_clone0_testing->Draw(" same");
 auto l0_e = new TLegend(0.65,0.15,0.9,0.3);
...
h_theta_e_single_LO_clone1_testing->Draw(" same");
 auto l1_e = new TLegend(0.65,0.15,0.9,0.3);
...
h_theta_e_single_LO_clone2_testing->Draw(" same");
 auto l2_e = new TLegend(0.65,0.15,0.9,0.3);
