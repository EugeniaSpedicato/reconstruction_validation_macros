...
h_res_vrtx_mu.at(10)=new TH1D("res10_vrtx_mu", "(thmu_rec_vrtx-thmu_true), theta_mu[1,2]mrad",120,-0.0004,0.0004);
h_res_vrtx_mu.at(11)=new TH1D("res11_vrtx_mu", "(thmu_rec_vrtx-thmu_true), theta_mu[2,3]mrad",120,-0.0004,0.0004);
...
//cout << "2) the_gen " << the_gen << " thmu_gen " << thmu_gen << " index " << index << " index_mu " << index_mu << endl;
...
if(stubs_muin==6 and mu_in==1)h_phi->Fill(p_muin.Phi()*(180/M_PI));
...
h_res_el_pre.at(m)->SaveAs(Form("res_prevrtx_el_%d.root",static_cast<char>(m)));
h_res_vrtx_el.at(m)->SaveAs(Form("res_vrtx_el_%d.root",static_cast<char>(m)));
//gPad->SetLogy();
}
n0.SaveAs("h_res_pre_el.pdf");
...
h_res_el_pre_clones.at(m)->SaveAs(Form("res_prevrtx_clones_el_%d.root",static_cast<char>(m)));
h_res_vrtx_el_clones.at(m)->SaveAs(Form("res_vrtx_clones_el_%d.root",static_cast<char>(m)));
}
n1.SaveAs("h_res_vrtx_el_clones.pdf");
...
h_res_mu_pre.at(m)->SaveAs(Form("res_prevrtx_AngleMu_%d.root",static_cast<char>(m)));
h_res_vrtx_mu.at(m)->SaveAs(Form("res_vrtx_AngleMu_%d.root",static_cast<char>(m)));
//gPad->SetLogy();
}
n2.SaveAs("h_res_pre_mu.pdf");
...
h_res_mu_pre_clones.at(m)->SaveAs(Form("res_prevrtx_clones_AngleMu_%d.root",static_cast<char>(m)));
h_res_vrtx_mu_clones.at(m)->SaveAs(Form("res_vrtx_clones_AngleMu_%d.root",static_cast<char>(m)));
}
n3.SaveAs("h_res_vrtx_mu_clones.pdf");

 
TCanvas in("in","in",700,700);
h_res_vrtx_muin->Draw();
in.SaveAs("h_res_pmuin.pdf");
