...
d_effMerged->Draw("E");
//a.SaveAs("old_comp/d_eff_RD_inputs_12_wip11.pdf");
d_effMerged->SaveAs("old_comp/d_eff_RD_inputs_12_wip11.root");

TCanvas b("b","b",700,700);
h_2dMerged->Draw();
h_2dMerged->SaveAs("old_comp/2D_RD_inputs_12_wip11.root");

TCanvas c("c","c",700,700);
theta_muMerged->Draw("E");
theta_muMerged->SaveAs("old_comp/theta_mu_RD_inputs_12_wip11.root");

TCanvas d("d","d",700,700);
theta_eMerged->Draw("E");
theta_eMerged->SaveAs("old_comp/theta_e_RD_inputs_12_wip11.root");

//signalM->SaveAs("old_comp/signal_RD_input0.root");
