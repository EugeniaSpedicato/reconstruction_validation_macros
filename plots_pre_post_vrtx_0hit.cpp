...
void plots_pre_post_vrtx_0hit(string path,string info){


array<TFile*,84> f_pre_1hit_el, f_post_1hit_el, f_pre_0hit_el, f_post_0hit_el,f_umb_e,f_umb_e_bv;
array<TFile*,84> f_pre_1hit_mu, f_post_1hit_mu, f_pre_0hit_mu, f_post_0hit_mu,f_umb_mu,f_umb_mu_bv;
...
f_pre_0hit_el.at(6*m+id)=TFile::Open(Form("%sres_prevrtx_clones_el_%d_0hit_LO_index%s_%s.root",path.c_str(),static_cast<char>(m),range.c_str(),info.c_str()));
f_post_0hit_el.at(6*m+id)=TFile::Open(Form("%sres_vrtx_clones_el_%d_0hit_LO_index%s_%s.root",path.c_str(),static_cast<char>(m),range.c_str(),info.c_str()));

if(m==0){f_umb_e.at(id)=TFile::Open(Form("%sumb_e_0hit_index%s_%s.root",path.c_str(),range.c_str(),info.c_str()));
f_umb_e_bv.at(id)=TFile::Open(Form("%sumb_e_bv_0hit_index%s_%s.root",path.c_str(),range.c_str(),info.c_str()));}
 }
}
...
f_pre_0hit_mu.at(6*m+id)=TFile::Open(Form("%sres_prevrtx_clones_mu_%d_0hit_LO_index%s_%s.root",path.c_str(),static_cast<char>(m),range.c_str(),info.c_str()));
f_post_0hit_mu.at(6*m+id)=TFile::Open(Form("%sres_vrtx_clones_mu_%d_0hit_LO_index%s_%s.root",path.c_str(),static_cast<char>(m),range.c_str(),info.c_str()));

if(m==0){f_umb_mu.at(id)=TFile::Open(Form("%sumb_mu_0hit_index%s_%s.root",path.c_str(),range.c_str(),info.c_str()));
f_umb_mu_bv.at(id)=TFile::Open(Form("%sumb_mu_bv_0hit_index%s_%s.root",path.c_str(),range.c_str(),info.c_str()));}
 }
}
...
array <TH1D*,14> h_pre_1hit_el, h_post_1hit_el, h_pre_0hit_el, h_post_0hit_el;
array <TH1D*,14> h_pre_1hit_mu, h_post_1hit_mu, h_pre_0hit_mu, h_post_0hit_mu;
...
array <TH1D*,6> t3{0};
 ...
 for(int id=0; id<6; id++){
        ...
        t2.at(id)=(TH1D*)f_pre_0hit_el.at(6*m+id)->Get(Form("res%d_el_pre_clones",static_cast<char>(m)));
        t3.at(id)=(TH1D*)f_post_0hit_el.at(6*m+id)->Get(Form("res%d_vrtx_el_clones",static_cast<char>(m)));
...
h_pre_0hit_el.at(m)=t2.at(0);
h_post_0hit_el.at(m)=t3.at(0);
}
...
//        t1.at(id)=(TH1D*)f_post_1hit_mu.at(6*m+id)->Get(Form("res%d_vrtx_mu_clones",static_cast<char>(m)));
        t2.at(id)=(TH1D*)f_pre_0hit_mu.at(6*m+id)->Get(Form("res%d_mu_pre_clones",static_cast<char>(m)));
        t3.at(id)=(TH1D*)f_post_0hit_mu.at(6*m+id)->Get(Form("res%d_vrtx_mu_clones",static_cast<char>(m)));
...
h_pre_0hit_mu.at(m)=t2.at(0);
h_post_0hit_mu.at(m)=t3.at(0);
}
...
*/auto h_sigma_mu_pre_0hit_clones = new TGraphErrors();
auto h_sigma_el_pre_0hit_clones = new TGraphErrors();
auto h_sigma_mu_post_0hit_clones = new TGraphErrors();
auto h_sigma_el_post_0hit_clones = new TGraphErrors();

//auto sigma_el_diff_1hit = new TGraphErrors();
//auto sigma_mu_diff_1hit = new TGraphErrors();
auto sigma_el_diff_0hit = new TGraphErrors();
auto sigma_mu_diff_0hit = new TGraphErrors();
...
h_sigma_el_pre_0hit_clones->SetPoint(m,edges_el[m]*1000,g1->GetParameter(2)*1000);
h_sigma_el_pre_0hit_clones->SetPointError(m,0.,g1->GetParError(2)*1000);
sigma_pre_el2[m]=g1->GetParameter(2)*1000;
gStyle->SetStatH(0.1);
gStyle->SetOptFit(0001);
gStyle->SetOptStat(1101);
}
n2.SaveAs(Form("%sresults/res_el_pre_0hit_%s.pdf",path.c_str(),info.c_str()));
...
h_pre_0hit_el.at(0)->Fit("g","R","",-0.0003,0.0003);
h_pre_0hit_el.at(0)->GetXaxis()->SetTitle("rad");
h_pre_0hit_el.at(0)->SetLineColor(kAzure+7);
h_pre_0hit_el.at(0)->Draw("hist same");
n2.cd(2);
h_pre_0hit_el.at(2)->Fit("g","R","",-0.0004,0.0004);;
h_pre_0hit_el.at(2)->GetXaxis()->SetTitle("rad");
h_pre_0hit_el.at(2)->SetLineColor(kAzure+7);
h_pre_0hit_el.at(2)->Draw("hist same");
n2.cd(3);
h_pre_0hit_el.at(9)->Fit("g");
h_pre_0hit_el.at(9)->GetXaxis()->SetTitle("rad");
h_pre_0hit_el.at(9)->SetLineColor(kAzure+7);
h_pre_0hit_el.at(9)->Draw("hist same");
n2.cd(4);
h_pre_0hit_el.at(13)->Fit("g");
h_pre_0hit_el.at(13)->GetXaxis()->SetTitle("rad");
h_pre_0hit_el.at(13)->SetLineColor(kAzure+7);
h_pre_0hit_el.at(13)->Draw("hist same");
gStyle->SetStatH(0.1);
gStyle->SetOptFit(0001);
gStyle->SetOptStat(1101);

//n3.SaveAs("%sresults/res_el_pre_0hit_%s.pdf");
...
h_sigma_el_post_0hit_clones->SetPoint(m,edges_el[m]*1000,g1->GetParameter(2)*1000);
h_sigma_el_post_0hit_clones->SetPointError(m,0.,g1->GetParError(2)*1000);
sigma_post_el2[m]=g1->GetParameter(2)*1000;
gStyle->SetStatH(0.1);
gStyle->SetOptFit(0001);
gStyle->SetOptStat(1101);
}
n4.SaveAs(Form("%sresults/res_el_post_0hit_%s.pdf",path.c_str(),info.c_str()));
...
h_sigma_mu_pre_0hit_clones->SetPoint(m,edges_mu[m]*1000,g1->GetParameter(2)*1000);
h_sigma_mu_pre_0hit_clones->SetPointError(m,0.,g1->GetParError(2)*1000);
sigma_pre_mu2[m]=g1->GetParameter(2)*1000;
}
n7.SaveAs(Form("%sresults/res_mu_pre_0hit_%s.pdf",path.c_str(),info.c_str()));
...
h_pre_0hit_mu.at(2)->Fit("g2");
h_pre_0hit_mu.at(2)->SetLineColor(kAzure+7);
h_pre_0hit_mu.at(2)->GetXaxis()->SetTitle("rad");
h_pre_0hit_mu.at(2)->Draw("hist same");
n2_mu.cd(2);
h_pre_0hit_mu.at(9)->Fit("g2","R","",-0.00012,0.00012);
h_pre_0hit_mu.at(9)->SetLineColor(kAzure+7);
h_pre_0hit_mu.at(9)->GetXaxis()->SetTitle("rad");
//h_pre_0hit_mu.at(9)->Rebin(2);
h_pre_0hit_mu.at(9)->Draw("hist same");
n2_mu.cd(3);
h_pre_0hit_mu.at(11)->Fit("g2","R","",-0.0002,0.0002);
h_pre_0hit_mu.at(11)->SetLineColor(kAzure+7);
h_pre_0hit_mu.at(11)->GetXaxis()->SetTitle("rad");
//h_pre_0hit_mu.at(11)->Rebin(2);
h_pre_0hit_mu.at(11)->Draw("hist same");
n2_mu.cd(4);
h_pre_0hit_mu.at(13)->Rebin(2);
h_pre_0hit_mu.at(13)->SetMinimum(1.);
h_pre_0hit_mu.at(13)->Fit("g2");
h_pre_0hit_mu.at(13)->SetLineColor(kAzure+7);
h_pre_0hit_mu.at(13)->GetXaxis()->SetTitle("rad");
h_pre_0hit_mu.at(13)->Draw("hist same");
gStyle->SetStatH(0.1);
gStyle->SetOptFit(0001);
gStyle->SetOptStat(1101);

//n2_mu.SaveAs("%sresults/res_pre_mu_0hit_%s.pdf");
...
h_sigma_mu_post_0hit_clones->SetPoint(m,edges_mu[m]*1000,g1->GetParameter(2)*1000);
h_sigma_mu_post_0hit_clones->SetPointError(m,0.,g1->GetParError(2)*1000);
sigma_post_mu2[m]=g1->GetParameter(2)*1000;
}
n8.SaveAs(Form("%sresults/res_mu_post_0hit_%s.pdf",path.c_str(),info.c_str()));


h_sigma_mu_pre_0hit_clones->SetName("mu_pre");
h_sigma_el_pre_0hit_clones->SetName("el_pre");
h_sigma_mu_post_0hit_clones->SetName("mu_post");
h_sigma_el_post_0hit_clones->SetName("el_post");


h_sigma_el_pre_0hit_clones->SaveAs(Form("%sresults/sigma_el_pre_0hit_%s.root",path.c_str(),info.c_str()));
h_sigma_el_post_0hit_clones->SaveAs(Form("%sresults/sigma_el_post_0hit_%s.root",path.c_str(),info.c_str()));
h_sigma_mu_pre_0hit_clones->SaveAs(Form("%sresults/sigma_mu_pre_0hit_%s.root",path.c_str(),info.c_str()));
h_sigma_mu_post_0hit_clones->SaveAs(Form("%sresults/sigma_mu_post_0hit_%s.root",path.c_str(),info.c_str()));
...
sigma_el_diff_0hit->SetPoint(m,edges_el[m]*1000,(sigma_post_el2[m]-sigma_pre_el2[m])/sigma_pre_el2[m]);
if(m!=0)sigma_mu_diff_0hit->SetPoint(m,edges_mu[m]*1000,(sigma_post_mu2[m]-sigma_pre_mu2[m])/sigma_pre_mu2[m]);
}
...
*/sigma_el_diff_0hit->SetName("el_0");
sigma_el_diff_0hit->GetYaxis()->SetTitle("(#sigma_post - #sigma_pre)/#sigma_pre");
sigma_el_diff_0hit->GetXaxis()->SetTitle("#theta_el (mrad)");
sigma_mu_diff_0hit->SetName("mu_0");
sigma_mu_diff_0hit->GetYaxis()->SetTitle("(#sigma_post - #sigma_pre)/#sigma_pre");
sigma_mu_diff_0hit->GetXaxis()->SetTitle("#theta_#mu (mrad)");


//sigma_el_diff_1hit->SaveAs(Form("%sresults/el_1.root"); 
//sigma_mu_diff_1hit->SaveAs(Form("%sresults/mu_1.root"); 
sigma_el_diff_0hit->SaveAs(Form("%sresults/el_0_%s.root",path.c_str(),info.c_str())); 
sigma_mu_diff_0hit->SaveAs(Form("%sresults/mu_0_%s.root",path.c_str(),info.c_str()));
